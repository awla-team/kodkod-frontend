...
const SubscribeModal: FC<{ open: boolean, onClose: () => void, reason: string }> = ({ open, onClose, reason = 'Conviertete en un miembro Pro' }) => {
  return (
    <Dialog open={open} PaperProps={{ className: 'p-3' }} maxWidth="md">
      ...
      <DialogContent dividers className="py-5">
        <div className="d-flex flex-column flex-lg-row gap-4 align-items-center">
          ...
          <div>
            <Typography className="mb-2">¡Suscríbete ya mismo a <b>Kodkod Pro</b> y accede a nuevas funciones y características que te ayudaran a convertir tu clase en un ambiente de sana convivencia!</Typography>
            <Typography>Con <b>Kodkod Pro</b> podrás:</Typography>
            <ul>
            ...
            <Typography fontWeight="bold">¿Qué estás esperando? Visita la página de suscripciones y elige la que más te convenga</Typography>
          </div>
        </div>
      </DialogContent>
