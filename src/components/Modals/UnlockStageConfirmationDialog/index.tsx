    ...
    >
      {unlockableStageData ? (
        ...
        <div>
          ...
          <DialogContent dividers className="py-4">
            <div className="mb-3">
              <Typography component="span" variant="body1">Esta fue la última etapa, y están apunto de finalizar la aventura. ¡Felicitaciones a todas y todos por su gran esfuerzo!</Typography>
            </div>
            <Typography component="h6" variant="subtitle1" fontWeight="bold" className="mb-1">¿Qué sucederá al finalizar la aventura?</Typography>
            <ul>
              <li>Los puntos de cada estudiante volverán a 0.</li>
              <li>No se podrán completar más misiones en esta aventura.</li>
              <li>L@s estudiantes mantendrán las recompensas que ya obtuvieron.</li>
            </ul>
            <Typography textAlign="center" variant="body1" fontWeight="bold">Pero no se preocupen, ¡podrán iniciar una nueva aventura!</Typography>
          </DialogContent>
          <DialogActions className="d-flex align-items-center mt-3">
            <Button variant={"outlined"} onClick={handleClose}>
              Cancelar
