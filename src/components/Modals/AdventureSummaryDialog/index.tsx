...
const AdventureSummaryDialog: React.FC<{
  ...
  return (
    ...
    >
      ...
      <DialogContent id="adventure-selection-onboarding-5" dividers className="d-flex flex-column p-0">
      ...
      <DialogActions className="d-flex align-items-center p-4">
        <Button id="adventure-selection-close-modal" variant={'outlined'} onClick={handleOnCloseModal}>
          Cancelar
        </Button>
        {!shownAdventure?.demo &&
        ...
        !user?.is_superuser ? (
          ...
          <Button id="adventure-selection-onboarding-6" variant="contained" color="primary" onClick={setAdventure}>
