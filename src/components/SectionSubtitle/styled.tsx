...
export const SectionSubtitleContainer = styled.div`
  div {
    ...
    background-color: ${(props: SectionSubtitleContainerProps) => props.filled ? (props.lineColor || '#fff') : 'transparent'};
    width: fit-content;
    font-weight: bold;
    margin: 0px;
  ...
  hr {
    margin: 4px 0px;
    border-top: 2px solid ${(props: SectionSubtitleContainerProps) => (props.lineColor || '#fff')};
    opacity: 0.5;
  }
`;