  ...
  useEffect(() => {
    if (adventure) {
      getRewardsByAdventure(adventure.id)
        .then(({ data }) =>
          setRewardsByType(groupBy(data, (i: IReward) => i.type))
        )
  ...
  return (
    <div>
      <div>
        ...
        <Typography>
          Obtendrás las siguientes recompensas cuando alcances el puntaje
          requerido.
        </Typography>
      ...
      <div className="mt-4">
        ...
        <Typography>
          Obtendrás las siguientes recompensas el <b>puntaje del curso</b> sume
          el requerido.
        </Typography>
        <RewardsContainer className="d-flex overflow-auto py-2">
