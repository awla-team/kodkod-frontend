          ...
          <>
            <form onSubmit={handleSubmit}>
              <div className='tw-space-y-6'>
                ...
                {editLessonActivities && editLessonActivities.length > 0 ? (
                  editLessonActivities.map((activity, index) => {
                    return (
                      <div
                        key={index}
                        className='tw-border tw-bg-gradient-to-r tw-from-blue-600 tw-to-cyan-500 tw-rounded-md tw-h-40 tw-flex tw-flex-col'
                      >
                ...
                <div className='tw-flex tw-justify-center tw-flex-cols-3 tw-gap-10'>
                  ...
                  <div
                    className='tw-border tw-w-auto tw-border-dashed tw-rounded-md tw-h-auto tw-flex tw-justify-center tw-items-center tw-flex-col hover:tw-cursor-pointer tw-transition-all tw-duration-200 tw-ease-in-out tw-bg-transparent hover:tw-bg-indigo-100'
                    onClick={() =>
                      openModal({
