...
export const AdventureContext = createContext<IAdventureContext>({ adventure: undefined });

const AdventureProvider: React.FC<IAdventureProviderProps> = ({ children, adventureId }) => {
